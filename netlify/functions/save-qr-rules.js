...
exports.handler = async (event) => {
  ...
  try {
    const {
      slug, name, destinations, fallback,
      rewardGoal, rewardName, programName,
      tiers, refEnabled, refBonus,
      promoTitle, promoDesc, promoButtonText, promoButtonLink,
      logoImage,
    ...
    console.log(`Saved: ${cleanSlug} | Goal: ${rewardGoal} stamps | Reward: ${rewardName} | Tiers: ${tiers ? tiers.length : 0} | Logo: ${logoImage ? "yes" : "no"}`);
